...
def test_get_monthly_summary_success(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    ...
    response = client.get("/analytics/monthly/2025-01")
...
@patch('app.routers.analytics.get_db')
@patch('app.routers.analytics.AnalyticsService.get_monthly_summary')
def test_get_monthly_summary_no_data(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
...
@patch('app.routers.analytics.get_current_user_id')
@patch('app.routers.analytics.get_db')
def test_get_monthly_summary_invalid_format(mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    """Edge case: Invalid month format should return 400"""
    mock_get_user_id.return_value = mock_user_id
    mock_get_db.return_value = mock_db

    response = client.get("/analytics/monthly/2025-1")
...
@patch('app.routers.analytics.get_current_user_id')
@patch('app.routers.analytics.get_db')
def test_get_monthly_summary_invalid_format_text(mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    """Edge case: Non-numeric month should return 400"""
    mock_get_user_id.return_value = mock_user_id
    mock_get_db.return_value = mock_db

    response = client.get("/analytics/monthly/january-2025")
...
@patch('app.routers.analytics.get_current_user_id')
@patch('app.routers.analytics.get_db')
def test_get_monthly_summary_invalid_month_13(mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    ...
    with patch('app.routers.analytics.AnalyticsService.get_monthly_summary') as mock_service:
        ...
        response = client.get("/analytics/monthly/2025-13")
...
@patch('app.routers.analytics.get_db')
@patch('app.routers.analytics.AnalyticsService.get_monthly_summary')
def test_get_monthly_summary_service_error(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
...
@patch('app.routers.analytics.get_db')
@patch('app.routers.analytics.AnalyticsService.get_monthly_summary')
def test_get_monthly_summary_current_month(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    ...
    response = client.get("/analytics/monthly/2025-12")
...
@patch('app.routers.analytics.get_db')
@patch('app.routers.analytics.AnalyticsService.get_monthly_summary')
def test_get_monthly_summary_past_year(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    ...
    response = client.get("/analytics/monthly/2024-01")
...
def test_get_yearly_summary_success(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    ...
    response = client.get("/analytics/year/2025")
...
@patch('app.routers.analytics.get_db')
@patch('app.routers.analytics.AnalyticsService.get_year_summary')
def test_get_yearly_summary_no_data(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
...
@patch('app.routers.analytics.get_db')
@patch('app.routers.analytics.AnalyticsService.get_year_summary')
def test_get_yearly_summary_single_month(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
...
@patch('app.routers.analytics.get_current_user_id')
@patch('app.routers.analytics.get_db')
def test_get_yearly_summary_year_too_low(mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    """Edge case: Year below minimum should return 400"""
    mock_get_user_id.return_value = mock_user_id
    mock_get_db.return_value = mock_db

    response = client.get("/analytics/year/2019")
...
@patch('app.routers.analytics.get_current_user_id')
@patch('app.routers.analytics.get_db')
def test_get_yearly_summary_year_too_high(mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    """Edge case: Year above maximum should return 400"""
    mock_get_user_id.return_value = mock_user_id
    mock_get_db.return_value = mock_db

    response = client.get("/analytics/year/2101")
...
@patch('app.routers.analytics.get_db')
@patch('app.routers.analytics.AnalyticsService.get_year_summary')
def test_get_yearly_summary_minimum_year(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    ...
    response = client.get("/analytics/year/2020")
...
@patch('app.routers.analytics.get_db')
@patch('app.routers.analytics.AnalyticsService.get_year_summary')
def test_get_yearly_summary_maximum_year(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    ...
    response = client.get("/analytics/year/2100")
...
@patch('app.routers.analytics.get_db')
@patch('app.routers.analytics.AnalyticsService.get_year_summary')
def test_get_yearly_summary_service_error(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
    """Error handling: Service error should return 500"""
    mock_get_user_id.return_value = mock_user_id
    mock_get_db.return_value = mock_db
...
@patch('app.routers.analytics.get_db')
@patch('app.routers.analytics.AnalyticsService.get_year_summary')
def test_get_yearly_summary_all_months(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
...
@patch('app.routers.analytics.get_db')
@patch('app.routers.analytics.AnalyticsService.get_year_summary')
def test_get_yearly_summary_zero_spending_months(mock_service, mock_get_db, mock_get_user_id, client, mock_db, mock_user_id):
